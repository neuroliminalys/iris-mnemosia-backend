...
from src.iris_mnemosia_backend.core.config.config import Settings
from src.iris_mnemosia_backend.core.entities import (
...
print(DatabaseModel.metadata.tables.keys())
